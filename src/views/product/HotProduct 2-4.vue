<template>
  <div class="conPage">
    ...
    <div class="topBack">
      ...
      <!--    轮播图分类 -->
      <div class="filmBox" style="margin-top: 450px;">
        <!--      分类-->
...
export default {
  ...
  methods: {
    toDetail(id) {
      ...
      // }
      // if (this.flag == 2) {
      //   window.location.href = `http://yxfmm.bjyxfl.com/film/#/couponsdetail?id=` + this.listItem.id
      // }
    },
    // 轮播
    getSwiper() {
...
.conPage {
  min-height: 100vh;
  background-image: linear-gradient(to bottom, #ffd0cb, #FF5666);
}

.topBack {
  background-image: url("../../assets/hotshop/ht.png");
  ...
  .detail {
    background-image: linear-gradient(to right, #FF5666, #FFBF0B);
    width: 25px;
    height: 6px;
    margin: 5px auto 0px;
    border-radius: 30px;
...
.shopBox {
  ...
  .shopItem {
    background-image: linear-gradient(to bottom, #FFF0C9, #FFF0C9);
    border-radius: 10px;
    padding: 10px;
    ...
    .more {
      ...
      box-shadow: -4px 1px 10px 1px #FFF0C9;
      color: #8E8E8E;
      z-index: 10;
      display: flex;
      align-items: center;
