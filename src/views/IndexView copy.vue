    ...
    <div class="topBox" ref="topBox">
      <div class="topPage">
        ...
        <div class="searchBox">
          ...
          <!-- 自定义搜索框 (还原截图样式) -->
          <div class="searchValue" @click="toOther('/productList?index=1')" v-if="$store.state.festivals != 2">
      ...
      <div>
        <div class="brandSection">
          <!-- 品牌推荐 -->
          <div class="brandTitle"><span>品牌推荐</span><span style="font-size: 11px;color: #707070;"
              @click="BrandSeasonPage()">更多</span></div>
          <div class="brandList">
  ...
  methods: {
    ...
    getIndex() {
      return getIndexList().then(res => {
        if (res.code == 200) {
          this.brandList = res.data.online || []
          this.bannerList = res.data.banner || []
          // this.classList = (res.data.tubiao || []).slice(0, 8)
          this.picList1 = (res.data.zhanuma || []).slice(0, 5)
          this.picList2 = (res.data.zhanuma || []).slice(5, 10)
